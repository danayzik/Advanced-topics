...
namespace GameManager_206038929_314620071 {
    ...
    SFMLRenderer::SFMLRenderer(size_t rows, size_t cols) : rows(rows), cols(cols), screenWidth(cols * cellSize),
    ...
    void SFMLRenderer::initialize() {
        ...
        for (size_t i = 0; i < tanksTextures.size(); i++) {
            std::string filename = "GameManager/assets/tank_" + std::to_string(i + 1) + ".png";
