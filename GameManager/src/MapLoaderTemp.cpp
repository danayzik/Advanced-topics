...
//                    &gameMap.entityManager.createTank(y, x, playerNumber % 2 == 1 ? Direction::Left : Direction::Right,
//                                                      playerNumber, tankCount, gameManager.numShells)
//            );
//            tankCount++;
...
//
//        if (!readSettings())
//            throw std::runtime_error("Failed to read settings from map file: " + filePath + "\n" + settingsExamples);
//
//        processMapData();
//
